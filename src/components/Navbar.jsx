    ...
    <div>
        <BrowserRouter>
          <nav className='bg-sky-500 flex justify-between items-center text-white py-6 px-8 md:px-32   md:h-full md:w-full'>
            ...
            <div className={`absolute xl:hidden top-24 left-0 w-full bg-red-600 text-white flex flex-col items-center gap-6 font-semibold  text-lg transform transition-transform
